    ...
    <ul class="list-group list-group-flush">
      <?php $__empty_1 = true; $__currentLoopData = $decks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
        <li class="list-group-item d-flex justify-content-between align-items-center">
          ...
          <button type="button" class="btn btn-sm btn-outline-primary deck-open" data-deck-id="<?php echo e($d->id); ?>"><i class="bi bi-box-arrow-up-right me-1"></i>Open</button>
        </li>
...
<?php $__env->startPush('scripts'); ?>
  <script>
    const searchUrl = <?php echo json_encode(route('search'), 15, 512) ?>;
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\agull\OneDrive\Documents\Visual Studio\GIBLE\resources\views/flashcards.blade.php ENDPATH**/ ?>