...
<html lang="en">
  <head>
    ...
    <meta name="description" content="{{ $metaDescription ?? 'GIBLE — Wikipedia, quizzes, flashcards, and study planning in one calm workspace.' }}" />
  ...
  <body class="gible-body">
    ...
    <main id="gible-main" class="container pb-4 pb-md-5 gible-main" tabindex="-1">@yield('content')</main>
